...
export default function NavBar() {
  ...
  return (
    <>
      ...
      {/*
        Mobile full-screen overlay — rendered as a sibling of <header>, NOT a child.
        backdrop-filter on the header creates a new containing block, which would
        confine a fixed child to the 72px header height. Outside the header, fixed
        inset-0 correctly anchors to the viewport regardless of scroll position.
      */}
      <div
        className="md:hidden fixed inset-0 z-[60] bg-pitch flex flex-col items-center justify-center gap-10"
        style={{
